...
import { MessageSquareText, LayoutDashboard, History, Users, Folder, Settings, Moon, Sun, Menu, MessageSquarePlus, Mail } from 'lucide-react';
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem>
             ...
             <SidebarMenuItem>
              <SidebarMenuButton asChild isActive={pathname === '/email'}>
                <Link href="/email">
                  <Mail />
                  Email
                </Link>
